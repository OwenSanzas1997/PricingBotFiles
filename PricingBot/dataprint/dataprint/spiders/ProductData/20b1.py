...
class A_Spider(scrapy.Spider):
    name = '20_b1' # change this first!!!
    allowed_domains = ['amazon.com']
    start_urls = [
        'https://www.amazon.com/Compatible-Pitney-DM100i-Cartridge-Postage/dp/B08DS33J2J'
    ]
    ...
    def parse(self, response):
        ...
        producer = (response.xpath('//a[contains(@id,"bylineInfo")]/text()').extract_first())
        
        # Reading Description
        description = response.xpath('//ul[contains(@class,"a-unordered-list a-vertical a-spacing-mini")]/li/span/text()').extract()
