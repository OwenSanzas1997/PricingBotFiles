...
class A_Spider(scrapy.Spider):
    name = '9_a' # change this first!!!
    allowed_domains = ['amazon.com']
    start_urls = [
        'https://www.amazon.com/Ecopost-MRP7722BLK-Cartridge-Compatible-Infinity/dp/B07D97WBDM'
    ]
    ...
    def parse(self, response):
        ...
        # Reading Description
        desc_tmp = response.xpath('//*[@id="feature-bullets"]/ul/li[2]/span/text()').extract()
