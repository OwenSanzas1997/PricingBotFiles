...
class A_Spider(scrapy.Spider):
    name = '10_a' # change this first!!!
    allowed_domains = ['amazon.com']
    start_urls = [
        'https://www.amazon.com/DoorStepInk-Remanufactured-Pitney-Bowes-787-1/dp/B08MWMVGQS',  # 787-1
        'https://www.amazon.com/Postageink-com-Postage-Cartridge-Sendpro-Replacement/dp/B08KSKG5HD'
    ]
