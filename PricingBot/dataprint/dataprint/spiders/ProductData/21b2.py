...
class A_Spider(scrapy.Spider):
    name = '21_b2'  # change this first!!!
    allowed_domains = ['mindfulpostage']
    start_urls = [
        # NeoPost IS6000
        'https://mindfulpostage.com/products/quadient-neopost-is6000-red-ink-tank-cartridge-compatible-with-is5000-is6000/'
    ]
    ...
    def parse(self, response):
        ...
        producer = 'Neopost' # (response.xpath('/html/body/div[2]/div[2]/div[1]/div[1]/section[2]/div[1]/span/a/span/strong/text()').extract_first())
