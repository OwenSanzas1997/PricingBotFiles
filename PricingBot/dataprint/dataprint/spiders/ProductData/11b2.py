...
class A_Spider(scrapy.Spider):
    name = '11_b2' # change this first!!!
    allowed_domains = ['postagemeterinkcartridges']
    start_urls = [
        # 787-3 black
        'https://www.postagemeterinkcartridges.com/pitney-bowes-787-8-red-ink-cartridge-large-for-sendpro-p-connect-series/'
    ]
    def parse(self, response):
        ...
        producer = (response.xpath('/html/body/div[2]/div[2]/div[1]/div[1]/section[2]/div[1]/span/a/span/strong/text()').extract_first())
        
        # Reading Description
        desc_tmp = response.xpath('/html/body/div[2]/div[2]/div[1]/div[1]/section[2]/div[1]/div[6]/div/div/div/div/ul/li[1]/span/text()').extract()
