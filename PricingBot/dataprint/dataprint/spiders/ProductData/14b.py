...
class A_Spider(scrapy.Spider):
    name = '14_b1'  # change this first!!!
    allowed_domains = ['postagemeterinkcartridges']
    start_urls = [
        # FP™ My Mail Printer Remanufactured Ink Cartridge
        'https://www.postagemeterinkcartridges.com/rps-mymail-francotyp-postalia-compatible-ink-cartridge/'
    ]
    ...
    def parse(self, response):
        ...
        producer = (response.xpath(
            '/html/body/div[2]/div[2]/div[1]/div[1]/section[2]/div[1]/span/a/span/strong/text()').extract_first())  # [7:]

        # Reading Description
        desc_tmp = response.xpath(
            '/html/body/div[2]/div[2]/div[1]/div[1]/section[2]/div[1]/div[6]/div/ul/li[2]/span/text()').extract()
