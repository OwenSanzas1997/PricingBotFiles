...
class A_Spider(scrapy.Spider):
    ...
    start_urls = [
        'https://www.amazon.com/Preferred-Postage-Supplies-4137700D-Replacement/dp/B01A9LVSVE'
    ]
    ...
    def parse(self, response):
        ...
        price = response.xpath(
            '//*[@id="corePriceDisplay_desktop_feature_div"]/div[1]/span/span[1]/text()').extract_first()
        price = price[1:]
